...
import { D, F, L, LA, M, MatrixEntry, N, R, VA, VA_OWN, VO } from './rbac-scopes';
...
const DEVELOPER_ROLE_MATRIX: MatrixEntry = {
  ...
  FUNCTION_CATALOG: R,
  DELIVERY_COMPENSATION_RULES: N,
  DELIVERY_CONFIGURATION: VO,
  FINANCE_BONUSES: L,
  FINANCE_SALARY: N,
  PROJECTS: L,
  TASKS: L,
