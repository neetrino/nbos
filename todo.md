...
- [x] Содержимое ядер: сначала 25 черновиков (5 видов × 5 размеров). **2026-09-21 решение 1.18:**
      ...
      Полный). **2026-09-21:** сид покрывает 9 видов enum (магазин, сайт компании, лендинг, визитка,
      CRM, web app, ERP, SaaS, mobile). OTHER и маркетинг не сеем. `pnpm seed:delivery-profiles`.
...
- [x] Ось `platform` (web / app / desktop) как отдельный признак сделки. На units не влияет:
      ...
      вида, enum для legacy остаётся. App Store-слот смотрит на platform APP. Виды enum пока не
      расширяли.
