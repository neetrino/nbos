...
- [ ] Экран каталога: левая колонка категорий, поиск, блоки по категориям, мелкие карточки.
      Юниты на карточке видны только с правом RULES VIEW; продавцу — только цена продажи.
...
- [ ] Типы продуктов и ось платформы: ревизия `ProductTypeEnum` (code / website / app / desktop) и
      отдельное поле платформы. На юниты не влияет — одинаковый функционал стоит одинаково.
- [ ] Конструктор в карточке сделки: продавец собирает комплект до создания продукта. Требует
      черновой конфигурации на сделке и цены продажи, поэтому идёт после схемы цен.
