...
| ------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Credentials         | `scope=active\|trash`, trash side-effects, folders Model 5/6   | 🟡 PARTIAL — naming `archivedAt` transitional; open items C-O1/C-O2                          |
...
| Global      | Trash inventory + retention resolver + unified purge (7.2–7.4); Profile A auto-purge backlog; Mail O2              |
