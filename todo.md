...
- [ ] **Следующий шаг.** Градации (tiers) внутри карточки функции: версии цены с привязкой к градации и
      связь выбранной функции с градацией. Сейчас импорт по объёму и мультиязычность сайт/система —
      отдельные карточки, поэтому на один продукт можно добавить два варианта одной работы и оплатить
      её дважды. До этого момента владелец публикует только те варианты, которые продаёт.
