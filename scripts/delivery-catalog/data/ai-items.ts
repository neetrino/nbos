...
export const AI_ITEMS: readonly CatalogSeedItem[] = [
  {
    ...
    scopeBoundaries:
      'Один провайдер модели, один источник знаний до 200 документов на одном языке, окно чата, передача оператору, ограничение тем и логирование. Обновление базы знаний, дополнительные языки и перенос архива — отдельная оценка. Токены оплачивает клиент отдельно.',
