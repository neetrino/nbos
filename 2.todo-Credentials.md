...
Credentials final access implementation depends on [1.todo-Access.md](./1.todo-Access.md).

Use the access canon:

- `docs/NBOS/02-Modules/07-My-Company/09-Platform-Access-Foundation.md`

Do not implement final `Project` / `Team` / manual override access behavior in Credentials until Platform Access Foundation is designed/implemented.
