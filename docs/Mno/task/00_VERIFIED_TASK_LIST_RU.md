...
> Составлено из документов `docs/Mno/task/*` и проверки кода. **Обновлено 2026-05-04** после закрытия pre-Phase 7 hardening в коде.
...
| Phase 7                             | По-прежнему: **ручной** browser smoke по `docs/PHASE_7_PRECHECK_MANUAL_QA.md`.                                                             |
...
1. **Ручной browser smoke** — чеклист `docs/PHASE_7_PRECHECK_MANUAL_QA.md` в сессии владельца.
