...
Дата: 2026-09-12. Статус: первый EN/RU срез в рабочем дереве; этап 4 почти закрыт live (тема, 403/conflict/network, HY-шрифт). Live token-expiry и production rollout открыты.
...
| 5         | В работе                 | Контракт GET/PATCH/cookie/SSR записан в coverage. Review: year-aria month picker уведена в каталог; мёртвые EN-константы dock/Create-Open сняты. Visual/login двух пользователей и production rollout не закрыты                                                                                                                                                                                                                              |
