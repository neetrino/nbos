...
| 5         | В работе                 | Отчёт в coverage. Parser 409 conflicts читает top-level и nested. Не в IMPLEMENTATION_DONE. Открыты: два пользователя, live token-expiry, production rollout                                                                           |
