...
Still English: payroll month-compensation sheet / KPI essays, non-employee `Search {kind}s…`, feature-module dock item labels, some credential form-sheet leftovers. Auth pages, emails, PDF. HY switcher still off. Nested create dialogs, Marketing chrome, Active Call overlay, shared checklist workbench, Delivery leftovers, payroll matrix, and credentials tiles/bulk/ENV are now EN/RU.
