...
| --- | ------------------------------------- | --------------------------------------------- | ------- | ------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 01  | Project Knowledge and Customer Memory | `01-Project-Knowledge-and-Customer-Memory.md` | PLANNED | Phase 2 | HIGH     | Promoted into Phase 2 documents `../42`–`../45`: Project base knowledge, Product overlays, isolated memory, live context, grounded Project Assistant and Messenger-owned `DRAFT_ONLY` replies. |
| 02  | Meeting Intelligence / Video Meetings V2 | `02-Meeting-Intelligence.md` | APPROVED | Video Meetings V2 (AI-gated) | HIGH | Authorized V1 audio → speaker-attributed transcript, evidence-linked summary and human-reviewed task suggestions; excluded from V1 and current AI Phase 2. |
