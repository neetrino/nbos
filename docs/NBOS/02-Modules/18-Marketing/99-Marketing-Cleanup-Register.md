...
### B1. Marketing module shell

Статус: `FOUNDATION DONE / NEEDS DEPTH` (**2026-05:** route `/marketing` + основные секции в runtime)
...
### B2. Sidebar entry for Marketing
...
### B9. Marketing Dashboard

Статус: `FOUNDATION DONE / NEEDS DEPTH` (**2026-05:** runtime dashboard + периоды; CPL/ROI без fake spend — см. канон)

Дальше: углубление виджетов, cohorts, внешние Ads API — вне текущего MVP (см. §D).

---

## C. Implementation order

1. ~~Add Marketing module route and sidebar entry.~~ Done (foundation).
2. ~~Add Marketing Settings: Channels and Accounts.~~ Done (foundation).
3. ~~Add Marketing Account model and UI.~~ Done (foundation).
4. ~~Add `Which one` dynamic attribution model.~~ Done (foundation).
5. ~~Update CRM Lead/Deal forms to use Marketing attribution.~~ Done (ongoing polish).
6. ~~Add Marketing Board and Activity model.~~ Done (foundation).
7. ~~Add launch popup with budget/start/end/expected payment date.~~ Done (foundation).
8. ~~Add Activity -> Finance Expense Card creation.~~ Done (foundation).
9. ~~Add Account -> Finance Expense Plan manual linking.~~ Done (foundation).
10. ~~Add Attribution Review screen.~~ Done (foundation).
11. ~~Add Marketing Dashboard.~~ Done (foundation); depth → §B9.
12. Add KPI data outputs for My Company — **partial** (`/my-company/kpi` control-center slice); deepen по канону My Company.
