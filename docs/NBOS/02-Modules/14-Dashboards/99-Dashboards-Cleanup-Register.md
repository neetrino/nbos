...
Runtime `Topbar` no longer contains a permanent global `Create` button. It keeps notifications and account controls only.
...
1. ~~Remove global `Create` from header.~~ Done (2026-04-30): topbar has notifications/account only.
