...
| Area                 | Status    | Action                                                                                                                                                                                                                                         |
| -------------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-04-29:** `POST …/drafts`, queue, `finalize-send-stub`, `reset-failed-to-draft`, `cancel`, **`POST …/accounts/:id/sync-stub`**, list `unreadOnly` + `needsLinkOnly`, **`PATCH …/threads/:id`**, mark-read + audits; без SMTP/sync/worker |
