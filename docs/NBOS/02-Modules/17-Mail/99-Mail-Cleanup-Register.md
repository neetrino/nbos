...
| Mail UI              | `PARTIAL` | **2026-04-29:** inbox (stub **sync** per mailbox, All / Unread / **Needs link**, **subject search** debounced), thread (needs-link PATCH, **Queue**/Cancel draft, Finalize/Cancel queued, **Reset failed→draft**, reply, mark read); **2026-04-30:** per-mailbox **health summary**; **outbound delivery log**; **thread list Prev/Next + counts**; нет реальной отправки/settings/live provider health                                                                       |
