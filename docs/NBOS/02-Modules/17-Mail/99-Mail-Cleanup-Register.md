...
| Area                 | Status    | Action                                                                                                                                                                                                              |
| -------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-04-29:** `POST …/drafts`, queue, `finalize-send-stub`, `cancel`, list `unreadOnly` + **`needsLinkOnly`**, mark-read + outbound audits; без SMTP/sync/worker                                                  |
...
| Mail UI              | `PARTIAL` | **2026-04-29:** inbox (All / Unread / **Needs link**), thread (**Queue** / **Cancel** на DRAFT, **Finalize stub** / **Cancel** на QUEUED), **Reply as draft**, **Mark read**; нет реальной отправки/settings/health |
