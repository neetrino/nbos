...
| Area                 | Status    | Action                                                                                                                                                                                                                      |
| -------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-04-29:** `POST …/drafts`, queue, `finalize-send-stub`, `cancel`, list `unreadOnly` + `needsLinkOnly`, **`PATCH …/threads/:id`** (`needsBusinessLink`), mark-read + audits; без SMTP/sync/worker                      |
...
| Mail UI              | `PARTIAL` | **2026-04-29:** inbox (All / Unread / **Needs link**), thread (**Clear/Flag needs link**, **Queue** / **Cancel**, **Finalize stub** / **Cancel**, **Reply as draft**, **Mark read**); нет реальной отправки/settings/health |
