...
| Area                 | Status    | Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| -------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-08-19 Slice B:** receive on BullMQ (`mail.sync` jobId), Gmail watch + history recovery, IMAP IDLE on worker + Redis lock, inbox poll cron default off; `sync-stub` removed. Slice C: inbound attachment download.                                                                                                                                                                                                                                                                        |
