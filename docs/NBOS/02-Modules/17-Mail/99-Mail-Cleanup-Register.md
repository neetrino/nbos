...
| Area                 | Status    | Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| -------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-04-29:** outbound draft/queue stub, paginated threads, delivery log, sync-stub, health-summary, list filters, mark-read + audits; **2026-06-12:** **Trash-first** — `trashed_at`, `POST …/delete` → Trash, `POST …/restore`, list `scope=active\|trash`, retention purge via platform job; без SMTP/sync/worker                                                                                                                                                                          |
