...
| Area                 | Status    | Action                                                                                                                                                                                                                                                                            |
| -------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mail backend module  | `PARTIAL` | **2026-04-29:** `MailOutboundMutationService` (drafts, queue, finalize-stub, cancel, reset-failed) + in-app notify; **`POST …/accounts/:id/sync-stub`**; list `unreadOnly` + `needsLinkOnly` + **`q`**, **`PATCH …/threads/:id`**, mark-read + audits; без SMTP/sync/worker       |
