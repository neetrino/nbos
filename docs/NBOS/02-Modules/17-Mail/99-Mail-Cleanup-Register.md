...
| Area                 | Status    | Action                                                                                                                                                                                           |
| -------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Mail backend module  | `PARTIAL` | **2026-04-29:** Nest `MailModule` — `GET …/accounts`, `GET …/threads`, `GET …/threads/:id` (`MAIL` VIEW); `POST …/threads/:id/mark-read` (`MAIL` EDIT); без sync/send/queue/OAuth                |
...
| Mail UI              | `PARTIAL` | **2026-04-29:** `/mail` inbox + thread detail, **Mark read** при `MAIL` EDIT; нет compose/reply/settings/health                                                                                  |
