...
Канон Messenger: `../09-Messenger/00-Messenger-Overview.md` (секция **Граница с Mail**), интеграции — `../09-Messenger/04-Messenger-Integrations.md` (**Mail**).

## Calendar

Основной Calendar NBOS не показывает входящие письма и email threads — это **Mail** или контекстные списки в CRM/Support/Projects.

- Слои Meetings / Delivery Deadlines / Personal не являются почтовым inbox.
- Напоминания о событии по времени — **Notifications**; запись встречи — Calendar/CRM.
- Обработка calendar invites из письма в каноне Mail вынесена за пределы MVP (`00-Mail-Overview.md` — не входит calendar invite processing).

Канон Calendar: `../10-Calendar/05-Calendar-Integrations.md` (**Mail**).
...
Граница с модулем Technical: `../15-Technical-Infrastructure/04-Technical-Integrations.md` (**Mail**).
