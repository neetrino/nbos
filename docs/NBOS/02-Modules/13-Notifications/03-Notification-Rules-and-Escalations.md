...
| `finance.invoice.payment_reminder_due`                                      | Subscription invoice unpaid; `notifications_enabled`; Yerevan day in `[dueDate − 5, dueDate]` (pay day, or issue day if we were late)                 | WhatsApp «оплатите в течение 5 дней» to Product WhatsApp Group. Catch-up if cron missed the anchor day. D-10 / D-2 (`dueDate − 10` / `− 2`) are retired.                                                                                                                                                                                                                                                                                                                                          |
