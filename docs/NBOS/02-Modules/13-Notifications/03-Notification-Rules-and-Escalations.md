...
Outbound WhatsApp text (accountant official request, client payment reminders, client invites) goes through one paced queue (`whatsapp.outbound-messages`, concurrency 1, 2s gap).
