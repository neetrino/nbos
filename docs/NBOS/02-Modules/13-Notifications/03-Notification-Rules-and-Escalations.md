...
| `invoice.awaiting_payment` / `finance.invoice.payment_reminder_d10` / `_d2` | **Retired.** Cron no longer creates pre-due client WhatsApp. Historical jobs may still deliver. Client letters are overdue w1/w2.                     | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Scheduler: `POST /api/scheduler/invoice-card-reminders` (Yerevan `asOf`) — official request only. Overdue client waves are **manual**, not cron.
...
| `subscription.payment_reminder` | Retired pre-due D-10/D-2 | Client WhatsApp only via manual overdue waves                            |
