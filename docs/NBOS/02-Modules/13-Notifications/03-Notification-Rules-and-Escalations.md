...
| `finance.invoice.official_request_due`                                      | Tax card in `Awaiting Payment`; official request not sent                                                                                             | Catch-up: enqueue accountant WhatsApp if auto-send on Awaiting entry failed. Primary trigger is entering Awaiting, not `dueDate`. Client payment reminders stay separate and, for Tax, require official request already sent.                                                                                                                                                                                                                                                                     |
