...
- **Company create**: multi-select **contacts** (optional; first = primary), optional **billing contact**, optional **legal name**, optional company phone/email/country; no manual contact UUID.
