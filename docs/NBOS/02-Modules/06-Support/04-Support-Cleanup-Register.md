...
| Ticket `TKT-` / Extension Deal `D-` codes | `OK`      | **2026-08-23:** both series use `entity_code_counters`. Ticket writers: `SupportService.create`. Deal writer here: `createExtensionDeal` (same `DEAL` scope as CRM). See AI C25. |
