...
- реальные report previews: KPI cards, charts, tables and data-quality warnings;
...
Каталог остаётся входной точкой, но пользователь должен видеть не технические `sourceEndpoints` и phase notes, а понятные бизнес-отчёты и их состояние.
