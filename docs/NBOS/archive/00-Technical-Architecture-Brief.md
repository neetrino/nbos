...
> Архивный документ. Полезен как исторический сводный brief, но не является активным каноном. При конфликте использовать `00-Documentation-Hub.md` и актуальные документы в `docs/NBOS`.
