...
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **UI**                       | External Messenger: списки разговоров, история, composer, зоны CRM Inbox / группы / Support / Finance (по канону Messenger). Company integrations: browse Gateway **chats** (`GET /api/chats` — groups + personal, inbox order). Groups-only `GET /api/groups` is for product bind / management. Live handoff: [Gateway INTEGRATION.md](https://github.com/neetrino/whatsapp-gateway/blob/main/docs/INTEGRATION.md). |
...
- [Gateway INTEGRATION.md](https://github.com/neetrino/whatsapp-gateway/blob/main/docs/INTEGRATION.md) — live picker/send contract (do not snapshot).
