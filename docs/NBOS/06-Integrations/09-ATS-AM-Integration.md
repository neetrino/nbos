...
| `GET /calls` (CALLS_VIEW journal), `GET /crm/calls`, `GET /crm/calls/:id`, `GET /crm/calls/:id/recording`, `GET /crm/calls/:id/screen` (pending click-to-call may peek ATS `history`), `PATCH /crm/calls/:id/note` |                                                                           |
