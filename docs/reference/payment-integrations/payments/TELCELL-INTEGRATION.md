...
>
> **Աղբյուր.** WEB Магазинный шлюз v1.2 (PostInvoice redirect + callback). `../official-docs/TelCell/WEB Магазинный шлюз v1.2.md`
...
- **Live.** TELCELL*LIVE*\* — live credentials.
...
- [ ] Env: TELCELL*TEST_MODE, TELCELL_SHOP_ID, TELCELL_SHOP_KEY (test) / TELCELL_LIVE*\* (live).
