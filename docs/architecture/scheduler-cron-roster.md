...
1. 🟢 **Ежемесячный биллинг** — каждый день в **11:00**: день оплаты 1 — с предпоследнего рабочего дня (следующий месяц); дни 2–31 — с 1-го текущего; пропуск дня догоняется.  
   `SCHEDULER_BILLING_ENABLED` · cron `SCHEDULER_BILLING_CRON` (default `0 11 * * *`)
...
4. 🟡 **Напоминания по счетам** — каждый день в **11:00** (не ночью): налог (official request) + клиенту «в течение 5 дней» в день оплаты / позднего выставления. «Не оплатили» — кнопка overdue.  
