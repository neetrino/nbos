...
| Automatic monthly preparation                               | Requested direction in BR-05; first-launch priority remains undecided                                  | Idempotent run creation, approved inclusion rules and owned failure handling               |
