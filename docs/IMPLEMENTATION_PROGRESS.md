...
- **Opened Delivery Card:** wide Deal-style drawer/full card для Product/Extension с sticky header, 2–3 колонками, first-screen working cockpit (`Requirements`, `Team`, `Accesses`, `Files`, `Key Links`, `Blockers`, `Languages`, `Conditional Setup`) и focused tabs `Work Space / Calls / Bonus / History` по канону — **L**
