...
- Delivery Card §8: вкладка Bonus — пагинация и релизы в drawer глубже первого экрана — M
...
- CTB-2 Projects: привязка шаблона к stage requirement (`CHECKLIST`), конфиг правил, создание instance по канону §6–7 док. 08 — L
