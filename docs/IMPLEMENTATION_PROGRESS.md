...
| Finance                     | Yes        | Yes          | Partial     | Partial | Subscription activation, invoice payment, invoice generation, reconciliation dashboard and orders drill-down foundations added |
