...
| Current task  | Documents section ACL + search_vector depth (Slice 6 remainder) |
...
| Phase 5 — Collaboration / knowledge | In progress |     ~65% | Multi-field document list search + snippets; activity/detail UX; ACL schema still open     |
...
2. Next normal slice: **Slice 6 remainder** — PostgreSQL `search_vector`/ranking, section-level ACL + document overrides, audit routing.
