...
| Current task  | Delivery Board v1                             |
...
| Phase 4 — Delivery ops              | In progress |     ~45% | Tasks/support list foundations exist; canonical lifecycle fields/actions are being adopted |
...
1. Continue Projects Hub lifecycle refactor: Delivery Board filters/actions and closed view depth.
