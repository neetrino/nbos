...
| Current task    | Reports export-job foundation      |
...
| Phase 6 — Control layer             | In progress | ~52%     | Reports catalog + Dashboard Control Center/projection/preferences shipped; export/schedule depth next           |
...
2. Next slice: Reports export-job foundation (`Reports` export jobs must write audited files through Drive).
