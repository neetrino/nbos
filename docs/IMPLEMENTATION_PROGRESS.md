...
| 2026-04-29    | Mail & Notifications | Mail MVP + **`q`**; in-app notify: stub sync, **draft saved**, queue, finalize FAILED, cancel, reset→draft (actor + owner); **`MailOutboundMutationService`**; **`in_app_notifications`** + Topbar API. |
