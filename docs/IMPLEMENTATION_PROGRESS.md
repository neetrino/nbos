...
| 2026-04-29    | Mail & Notifications | Mail MVP + **`q`**; in-app notify: stub sync, **queue**, finalize FAILED, cancel, reset failed→draft (actor + owner); **`MailOutboundMutationService`**; **`in_app_notifications`** + Topbar API. |
