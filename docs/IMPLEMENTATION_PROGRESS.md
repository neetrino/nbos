...
| Current task    | Scheduled report due runner        |
...
| Phase 6 — Control layer             | In progress | ~88%     | Reports catalog/export/schedule/data-quality foundation, simple recurrence, BullMQ export worker and Dashboard Control Center/defaults shipped; due runner next |
...
2. Next slice: scheduled report due runner that creates export jobs from active schedules.
