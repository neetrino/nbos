...
| 2026-04-30    | Docs                 | Mail boundaries in canon: Notifications (**Email** vs inbox); **Credentials** (mailbox secrets); **Drive** (`FileAsset` / attachments); **Messenger** (vs inbox) — cross-links + cleanup registers.                                                                                |
