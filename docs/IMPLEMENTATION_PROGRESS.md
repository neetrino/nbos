...
- **Professional Delivery Card design:** перед реализацией opened card сделать polished UI-дизайн/композицию wide drawer/full card в стиле Deal, но с delivery-focused UX: sticky header, 2–3 колонки, daily core fields, conditional blocks, tabs и responsive states. Источник истины: [`07-Delivery-Board.md`](NBOS/02-Modules/02-Projects-Hub/07-Delivery-Board.md) §8, [`03-Products-and-Extensions.md`](NBOS/02-Modules/02-Projects-Hub/03-Products-and-Extensions.md) §4.8, [`03-Project-Hub-Pages.md`](NBOS/05-UI-Specifications/03-Project-Hub-Pages.md) §0/§3. Не делать сырой layout без этого дизайн-среза — **M**
