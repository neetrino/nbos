...
- 🟢 [x] Синхронизировать `docs/дожать до 100% описанного.md` или заменить ссылкой на этот файл — S → **корень** `[дожать до 100% описанного.md](./дожать%20до%20100%25%20описанного.md)` — заглушка на `IMPLEMENTATION_PROGRESS.md` + `IMPLEMENTATION_DONE.md`; **архив** `[Progress Archive/дожать до 100% описанного.md](Progress%20Archive/дожать%20до%20100%25%20описанного.md)` — политика «не вести дубль матрицы построчно; источник правды — Progress/Done + `*-Cleanup-Register.md`»; в §04 Finance уточнена строка про summary/scheduler и срез `money_status`
