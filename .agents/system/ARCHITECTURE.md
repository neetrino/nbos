...
Library packages remaining inactive: internal `react-performance-review` and external-adapted `ui-accessibility-review` (pinned source metadata and reviewed source license inside the package). NBOS activated `code-review` and `security-review`.
