...
/** Expense catch-up window after D−60 invoice: first of client Paid or this D−30 window. */
export const CLIENT_SERVICE_RENEWAL_EXPENSE_WINDOW_DAYS = 30;
...
export const CLIENT_SERVICE_UPCOMING_WINDOW_DAYS = 90;
const UPCOMING_WINDOW_DAYS = CLIENT_SERVICE_UPCOMING_WINDOW_DAYS;
