    ...
    switch (tab) {
      ...
      case 'department': {
        const deptBranch = visibilityCtx
          ...
          : undefined;
        if (!rbacBypass && deptBranch) {
          andParts.push(deptBranch);
        } else {
      ...
      case 'secret': {
        const secretBranch = visibilityCtx
          ...
          : undefined;
        if (!rbacBypass && secretBranch) {
          andParts.push(secretBranch);
        } else {
          andParts.push({ accessLevel: 'SECRET' });
        }
        break;
      }
      case 'project': {
        const projectBranch = visibilityCtx
          ...
          : undefined;
        if (!rbacBypass && projectBranch) {
          andParts.push(projectBranch);
        } else {
          andParts.push({ accessLevel: 'PROJECT_TEAM' });
        }
        break;
      }
      case 'all':
