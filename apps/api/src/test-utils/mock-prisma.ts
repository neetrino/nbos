...
export function createMockPrisma() {
  const prisma = {
    ...
    projectAdditionalContact: createModelMock(),
    companyAdditionalContact: createModelMock(),
    ...
    productTeamMember: createModelMock(),
    ...
    fileAssetGrant: createModelMock(),
