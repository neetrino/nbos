...
export type DealTypeCardChrome = {
...
const PRODUCT_CHROME: DealTypeCardChrome = {
...
const EXTENSION_CHROME: DealTypeCardChrome = {
...
const MAINTENANCE_CHROME: DealTypeCardChrome = {
...
const OUTSOURCE_CHROME: DealTypeCardChrome = {
...
const NEUTRAL_CHROME: DealTypeCardChrome = {
...
const CHROME_BY_TYPE: Record<DealTypeKey, DealTypeCardChrome> = {
...
/** Type-tinted meta icons, readiness, and divider for CRM / delivery board cards. */
export function getDealTypeCardChrome(visual: DealTypePresentation): DealTypeCardChrome {
