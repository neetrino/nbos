    ...
    >
      <div className="border-border bg-card rounded-xl border p-4">
        ...
        <p className="text-muted-foreground mt-1 text-xs">
          Referral commission from client cash: classic after delivery and full payment;
          subscription on each paid subscription invoice.
        </p>
        {actionError ? (
        ...
        <div className="border-border mt-5 border-t pt-4">
          ...
          <p className="text-muted-foreground mt-1 text-xs">
            Select eligible accruals to create a payout batch. Approve draft batch to create a
