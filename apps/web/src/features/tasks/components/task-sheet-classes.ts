...
/** Right task sheet — ~58vw on sm+ (tasks list / workspace). */
export const TASK_SHEET_WIDTH_CLASS =
  'flex w-full flex-col gap-0 overflow-hidden p-0 shadow-2xl data-[side=right]:w-full sm:max-w-none sm:data-[side=right]:w-[58vw]';

/** Anchor floating rail to the left edge of {@link TASK_SHEET_WIDTH_CLASS}. */
export const TASK_SHEET_RAIL_ANCHOR_CLASS = 'sm:right-[58vw]';
