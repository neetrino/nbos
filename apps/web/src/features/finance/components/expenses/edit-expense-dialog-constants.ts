...
/** Equal-width rows in expense/subscription detail General — 1 col mobile, multi-col sm+. */
export {
  FORM_FIELD_ROW_3_CLASS as EXPENSE_SHEET_FIELD_ROW_3_CLASS,
  FORM_FIELD_ROW_2_CLASS as EXPENSE_SHEET_FIELD_ROW_2_CLASS,
  FORM_FIELD_CELL_CLASS as EXPENSE_SHEET_FIELD_CELL_CLASS,
} from '@/components/shared/create-form';
