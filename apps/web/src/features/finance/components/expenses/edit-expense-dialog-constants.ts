...
export const EXPENSE_SHEET_FIELD_ROW_3_CLASS = 'grid grid-cols-1 gap-3 sm:grid-cols-3';

export const EXPENSE_SHEET_FIELD_ROW_2_CLASS = 'grid grid-cols-1 gap-3 sm:grid-cols-2';
