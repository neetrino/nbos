...
/** Matches Finance dashboard zone card icon colors (emerald / amber / violet / sky). */
export const FINANCE_HEADER_ZONE_ACCENTS: Record<FinanceSectionId, HeaderNavAccent> = {
  revenue: {
