    ...
    <div className="space-y-6 px-5 py-4">
      {nextPayroll ? (
        <section className="border-border bg-card rounded-2xl border p-5">
          <h2 className="text-foreground text-sm font-semibold">{t('nextLine')}</h2>
      ...
      <section className="border-border bg-card rounded-2xl border p-5">
        <h2 className="text-foreground text-sm font-semibold">{t('salaryByMonth')}</h2>
        <p className="text-muted-foreground mt-1 text-xs leading-snug">{t('salaryByMonthHint')}</p>
        <div className="mt-4">
