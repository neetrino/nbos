...
export function Topbar({ showMobileMenuButton = false, onMobileMenuClick }: TopbarProps) {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          'border-border/70 bg-background/88 supports-[backdrop-filter]:bg-background/72 sticky top-0 z-30 flex h-16 shrink-0 items-stretch gap-3 overflow-visible px-4 backdrop-blur-md max-md:h-14 sm:gap-4 sm:px-6',
